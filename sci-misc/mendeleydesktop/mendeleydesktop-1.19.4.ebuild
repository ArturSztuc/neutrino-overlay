...
MY_WEB_PREFIX="https://desktop-download.mendeley.com/download/linux"
#MY_WEB_PREFIX="https://desktop-download.mendeley.com/download/linux/mendeleydesktop-1.19.4-linux-x86_64.tar.bz2
MY_P_AMD64="${P}-linux-x86_64"
MY_P_X86="${P}-linux-i486"

DESCRIPTION="Free reference manager and academic social network for desktop and web"
HOMEPAGE="https://www.mendeley.com/"
SRC_URI="
	amd64? ( ${MY_WEB_PREFIX}/${MY_P_AMD64}.tar.bz2 )
	x86? ( ${MY_WEB_PREFIX}/${MY_P_X86}.tar.bz2 )
	amd64-linux? ( ${MY_WEB_PREFIX}/${MY_P_AMD64}.tar.bz2 )
	x86-linux? ( ${MY_WEB_PREFIX}/${MY_P_X86}.tar.bz2 )"

# SRC_URI="
#	amd64? ( https://www.mendeley.com/autoupdates/installer/Linux-x64/stable-incoming )
#	x86? (  https://www.mendeley.com/autoupdates/installer/Linux-x86/stable-incoming )
#	amd64-linux? ( https://www.mendeley.com/autoupdates/installer/Linux-x64/stable-incoming )
#	x86-linux? (  https://www.mendeley.com/autoupdates/installer/Linux-x86/stable-incoming )"
...
src_install(){
	...
	dosym /opt/mendeleydesktop/bin/mendeleydesktop /usr/bin/mendeleydesktop
}
